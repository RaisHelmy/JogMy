...
namespace JogMy.Migrations
{
    ...
    [Migration("20250730131819_AddTrackMedia")]
    partial class AddTrackMedia
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JogMy.Models.ActivityMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("JogMy.Models.TrackMedia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("JoggingTrackId");

                    b.ToTable("TrackMedia");
                });
            ...
            modelBuilder.Entity("JogMy.Models.TrackMedia", b =>
                {
                    b.HasOne("JogMy.Models.JoggingTrack", "JoggingTrack")
                        .WithMany("MediaFiles")
                        .HasForeignKey("JoggingTrackId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("JoggingTrack");
                });
